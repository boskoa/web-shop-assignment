...
})({"eVxwc":[function(require,module,exports) {
...
document.addEventListener("scroll", (e)=>{
    ...
    if (lastPosition < newPosition) header.style.transform = "translateY(-65px)";
    else header.style.transform = "translateY(0px)";
    lastPosition = newPosition <= 60 ? 60 : newPosition;
});
// path
const dummyPath = new URL("/all-products/haircare/restorative-hair-mask", window.location.origin);
...
function toggleMenu() {
    if (menuActive) menu.classList.remove("menu-active");
...
document.addEventListener("mousedown", (e)=>{
    e.stopPropagation();
    if (!menu.contains(e.target) && menuActive) toggleMenu();
});
// search icon
...
const condition = 3;
const width = deviceWidth > 700 ? viewport.offsetWidth / 3 : viewport.offsetWidth;
let position = 0;
...
},{}]},["eVxwc","5J9JY"], "5J9JY", "parcelRequire01a0")

//# sourceMappingURL=product.ebeb6277.js.map
